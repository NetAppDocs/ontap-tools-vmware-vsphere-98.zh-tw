...
+
https://imt.netapp.com/matrix/imt.jsp?components=99343;&solution=1777&isHWU&src=IMT["互通性對照表工具"]
...
. 輸入詳細資料以自訂部署精靈。
+
請參閱 link:../deploy/reference_considerations_for_deploying_ontap_tools_for_vmware_vsphere.html["部署自訂考量"] 以取得完整詳細資料。
